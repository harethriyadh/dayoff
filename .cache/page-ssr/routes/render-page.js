...
// EXTERNAL MODULE: external "/home/harith/test/dayoff/node_modules/react/index.js"
var index_js_ = __webpack_require__(2017);
...
var _react = _interopRequireDefault(__webpack_require__(2017));
...
const React=__webpack_require__(2017);const{grabMatchParams}=__webpack_require__(5870);const{StaticQueryContext}=__webpack_require__(123);const{headExportValidator,filterHeadProps,isElementType,isValidNodeName,warnForInvalidTag}=__webpack_require__(9226);const{ServerLocation,Router}=__webpack_require__(6462);const{renderToString}=__webpack_require__(1173);const{parse}=__webpack_require__(6192);const styleToOjbect=__webpack_require__(9108);function applyHtmlAndBodyAttributesSSR(htmlAndBodyAttributes,{setHtmlAttributes,setBodyAttributes}){if(!htmlAndBodyAttributes)return;const{html,body}=htmlAndBodyAttributes;setHtmlAttributes(html);setBodyAttributes(body);}function getValidHeadNodesAndAttributesSSR(rootNode,htmlAndBodyAttributes={html:{},body:{}}){const seenIds=new Map();const validHeadNodes=[];// Filter out non-element nodes before looping since we don't care about them
...
"use strict";
module.exports = require("/home/harith/test/dayoff/.cache/ssr-builtin-trackers/http");
...
"use strict";
module.exports = require("/home/harith/test/dayoff/node_modules/react-dom/server.js");
...
"use strict";
module.exports = require("/home/harith/test/dayoff/node_modules/react/index.js");
...
var React = _interopRequireWildcard(__webpack_require__(2017));
...
var _react = __webpack_require__(2017);
 ...
 * LICENSE file in the root directory of this source tree.
 */
var aa=__webpack_require__(2460),e=__webpack_require__(2017),k=null,l=0,m=!0;function p(a,b){a=a.write(b);m=m&&a}
...
"use strict";
module.exports = require("/home/harith/test/dayoff/.cache/ssr-builtin-trackers/https");
...
exports.components={"component---src-pages-index-jsx":()=>__webpack_require__.e(/* import() | component---src-pages-index-jsx */ 279).then(__webpack_require__.bind(__webpack_require__, 7325)),"component---src-pages-login-jsx":()=>Promise.all(/* import() | component---src-pages-login-jsx */[__webpack_require__.e(492), __webpack_require__.e(664)]).then(__webpack_require__.bind(__webpack_require__, 5534)),"component---src-pages-register-jsx":()=>Promise.all(/* import() | component---src-pages-register-jsx */[__webpack_require__.e(492), __webpack_require__.e(58)]).then(__webpack_require__.bind(__webpack_require__, 3770))};
...
"use strict";
module.exports = require("/home/harith/test/dayoff/.cache/ssr-builtin-trackers/fs");
...
/******/ 			return "" + ({"58":"component---src-pages-register-jsx","279":"component---src-pages-index-jsx","664":"component---src-pages-login-jsx"}[chunkId] || chunkId) + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
const React=__webpack_require__(2017);const path=__webpack_require__(2003);const{renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(1173);const{ServerLocation,Router,isRedirect}=__webpack_require__(6462);const merge=__webpack_require__(4744);const{StaticQueryContext}=__webpack_require__(123);const fs=__webpack_require__(8508);const{WritableAsPromise}=__webpack_require__(7227);const{RouteAnnouncerProps}=__webpack_require__(6858);const{apiRunner,apiRunnerAsync}=__webpack_require__(9432);const asyncRequires=__webpack_require__(6877);const{version:gatsbyVersion}=__webpack_require__(5818);const{grabMatchParams}=__webpack_require__(5870);const{headHandlerForSSR}=__webpack_require__(988);const{SlicesResultsContext,SlicesContext,SlicesMapContext,SlicesPropsContext}=__webpack_require__(2024);const{ServerSliceRenderer}=__webpack_require__(8455);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
